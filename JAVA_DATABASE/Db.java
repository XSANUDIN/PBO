...
public class Db {
    ...
    public static void insert(int id,String judul_buku,int tahun_terbit,int stok,int penulis){
        try {
            Class.forName(JDBC_DRIVER);
            conn = DriverManager.getConnection(DB_URL,USER,PASS);
            stmt = conn.createStatement();
    ...
    public static void edit(int id,String Ujudul_buku,int Utahun_terbit,int Ustok,int Upenulis){
        try{
            Class.forName(JDBC_DRIVER);
            conn = DriverManager.getConnection(DB_URL,USER,PASS);
            stmt = conn.createStatement();
